...
class OllamaConnectionError(Exception):
    """Raised when the Ollama inference server is unreachable."""
    pass
...
def get_ollama_response(prompt):
    ...
    try:
        ...
        raise OllamaConnectionError(f"Ollama server at {OLLAMA_URL} is unreachable.") from e
    except Exception as e:
        raise OllamaConnectionError(f"Unexpected error communicating with Ollama.") from e
